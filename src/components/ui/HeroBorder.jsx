...
export default function HeroBorder({ active, done, children, style = {} }) {
  ...
  return (
    <div style={{ position: "relative", ...style }}>
      <span style={{ position: "absolute", bottom: 0, left: 0, width: "1px", background: C.red, boxShadow: `0 0 10px ${C.redGlow}`, height: active ? "100%" : "0%", transition: `height ${DUR}s cubic-bezier(.4,0,.2,1) ${d(0)}` }} />
