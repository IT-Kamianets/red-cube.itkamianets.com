...
export default function Amenities({ sectionRef, boxRef, headingRef }) {
  ...
  return (
    <section id="amenities" ref={setRef} style={{ background: C.darkBg, padding: "clamp(56px,9vw,112px) clamp(20px,5vw,64px)", borderTop: `1px solid rgba(100,120,140,0.12)` }}>
